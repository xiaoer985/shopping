    ...
    return (
      <>
        <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['2']}>
          ...
          <SubMenu icon={<SkinOutlined />} style={{color:"#40a9ff"}} title="性别选择">
            <Menu.Item key="setting:1" onClick={() => this.onScreen()}>所有</Menu.Item>
            <Menu.Item key="setting:2" onClick={() => this.onSelecte("man")}>男</Menu.Item>
            <Menu.Item key="setting:3" onClick={() => this.onSelecte('girl')}>女</Menu.Item>
